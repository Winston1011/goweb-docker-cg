...
const (
	pathGetUserCourse = "/goweb-docker-cg/api/user/get-user-course"
	pathGetUserInfo   = "/goweb-docker-cg/api/user/getlist"

	pathBuyCourse     = "/goweb-docker-cg/api/course/buy"
	pathGetCourseInfo = "/goweb-docker-cg/api/course/getinfo"
)
